...
params = {
    'epochs': [10, 20],
    'n_first': 256 * 2**np.arange(3),
    'n_second': 128 * 2**np.arange(3),
    'dropout_first': 0.1 * np.arange(3, 6),
    'dropout_second': 0.1 * np.arange(3, 6),
    'add_layers': np.arange(2,4),
    'batch_size': [2048, 4096],
    'learning_rate': 1E-6 * 10 ** (np.arange(4)),
}
#%%
random.seed(2)
